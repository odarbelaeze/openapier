...
// Paginated is a generic model for paginated objects
type Paginated[T any] struct {
	// Items are the actual paginated items
	Items []T `json:"items"`
...
// @summary List todos
// @response 200 application/json Paginated[Todo] Paginated list of todos
// @response 500 application/json RestError Internal server error
// @router /todos [get]
func TodoList(w http.ResponseWriter, r *http.Request) {
	var paginatedTodos Paginated[Todo]
